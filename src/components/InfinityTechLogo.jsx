...
export default function InfinityTechLogo({ size = 512, className, style, hideInfinity = false, onlyInfinity = false, ...rest }) {
  const uid = "infinity-tech-" + useId().replace(/[^a-zA-Z0-9_-]/g, "");

  if (onlyInfinity) {
    return (
      <svg className={className} style={style} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1254 1254" width={size} height={size} fill="none" role="img" aria-hidden="true" {...rest}>
        <defs>
        ...
        <g id={`${uid}-logo-art`} data-part="logo-art" strokeLinecap="round" strokeLinejoin="round">
          <g id={`${uid}-infinity`} data-part="infinity" data-intro-infinity="" data-center-x="627" data-center-y="625">
  ...
  return (
<svg className={className} style={style} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1254 1254" width={size} height={size} fill="none" role="img" aria-labelledby={`${uid}-logo-title ${uid}-logo-description`} {...rest}>
...
<circle id={`${uid}-hub-disc`} data-intro-core="" cx="627" cy="625" r="208" fill={`url(#${uid}-hub-gradient)`}/>
